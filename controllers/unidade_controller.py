...
from services.unidade_service import (atualizar_unidade_service, deletar_unidade_service,
        listar_unidade_por_id_service, listar_unidades_service,
...
@router.patch("/{unidade_id}", response_model=UnidadeResponse, status_code=200)
